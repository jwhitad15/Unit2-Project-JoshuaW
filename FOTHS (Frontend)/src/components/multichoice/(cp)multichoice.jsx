...
//                 selectedOption: "", // Reset selected option for the previous question
//             }));
//         }
//     };
...
//                         <p> <Question question={questionBank[currentQuestion]} selectedOption={selectedOption} onOptionChange={this.handleOptionChange} onSubmit={this.handleFormSubmit} /> </p>
//                     </main>
//                 )}
//                 {quizEnd && (
//                     <main className="quiz-display">

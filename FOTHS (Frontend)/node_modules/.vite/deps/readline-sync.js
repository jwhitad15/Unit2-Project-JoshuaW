...
var require_readline_sync = __commonJS({
  "../../../../../node_modules/readline-sync/lib/readline-sync.js"(exports) {
    ...
    function _execFileSync(options, execOptions) {
      ...
      var res = {}, pathStdout = getTempfile("readline-sync.stdout"), pathStderr = getTempfile("readline-sync.stderr"), pathExit = getTempfile("readline-sync.exit"), pathDone = getTempfile("readline-sync.done"), crypto = require_crypto(), hostArgs, shellPath, shellArgs, exitCode, extMessage, shasum, decipher, password;
...
export default require_readline_sync();
//# sourceMappingURL=readline-sync.js.map
